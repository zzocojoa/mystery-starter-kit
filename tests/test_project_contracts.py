...
def test_production_config_template_passes_schema() -> None:
    ...
    assert document["channel_content_version"] == "2.1.0"
    assert document["variation_engine_version"] == "2.1.0"
    assert document["variation_catalog_version"] == "2.1.0"
    assert document["genre"] == "CRIME_EVENT_THRILLER"
